...
<div class="card mx-auto mt-5" style="max-width: 600px;">
    ...
    <div class="card-body">
        ...
        <form action="index.php?step=admin_account" method="POST">
            <input type="hidden" name="csrf_token" value="<?= \Installer\Core\Utils::getCsrfToken() ?>">
            <div class="mb-3">
                <label for="admin_username" class="form-label">Admin Username</label>
                <input type="text" class="form-control" id="admin_username" name="admin_username" value="<?= $admin_username ?? '' ?>" required>
            </div>
            <div class="mb-3">
            ...
            <div class="d-flex justify-content-between">
                <a href="index.php?step=app_config" class="btn btn-secondary">Previous</a>
